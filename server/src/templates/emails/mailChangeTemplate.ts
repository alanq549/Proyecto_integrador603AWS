export const emailChangeTemplate = (token: string, newEmail: string) => `
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirmación de Correo - Estacionamiento Martinez</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Estás intentando actualizar tu dirección de correo electrónico a:</p>
        <p class="highlight">${newEmail}</p>
        
        <p>Por favor utiliza el siguiente código de verificación para confirmar este cambio:</p>
        
        <div class="code-container">
            <div class="code">${token}</div>
        </div>
        
        <p class="info-text">Este código es válido por 15 minutos. Si no solicitaste este cambio, por favor ignora este mensaje.</p>
